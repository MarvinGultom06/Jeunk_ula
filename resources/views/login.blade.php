  ...
  <div class="min-h-screen flex items-center justify-center">
    <div class="max-w-md w-full p-8 bg-white rounded-lg shadow-lg">
      ...
      <form id="loginForm" class="mt-8 space-y-6">
        ...
        <div>
          <button type="submit" class="w-full bg-primary text-white p-2 rounded-lg">Login</button>
        </div>
        <div class="text-center mt-4">
          <a href="{{ route('register') }}" class="text-sm text-primary hover:underline">Don't have an account? Register here</a>
        </div>
      </form>
